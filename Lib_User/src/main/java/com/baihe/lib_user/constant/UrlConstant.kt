package com.baihe.lib_user.constant
...
object UrlConstant {
    ...
    const val SUBMIT_PASSWORD = "/owner/x/x"
    const val CHECK_VERSION = "/owner/x/x"
    const val SET_PUSH = "/owner/x/x"
    const val DELETE_ACCOUNT = "/owner/x/x"
}