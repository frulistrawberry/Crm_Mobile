...
public class FlowLayout extends ViewGroup {
     ...
     * laybel默认背景资源
     */
    private static final int LABEL_BACKGROUND_DEFAULT = R.drawable.common_button_round_blue_stroke;
    /**
     * laybel默认文字颜色
     */
    private static final int LABEL_TEXT_COLOR_DEFAULT = Color.parseColor("#667BFF");
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        labelTextSize = DpToPx.pxToSp(typedArray.getDimension(R.styleable.FlowLayout_label_textSize, DpToPx.pxToSp( 13)));
        ...
        labelHorizontalSpaceSize = typedArray.getDimensionPixelSize(R.styleable.FlowLayout_label_horizontal_space, DpToPx.dpToPx( 8));
        labelVerticalSpaceSize = typedArray.getDimensionPixelSize(R.styleable.FlowLayout_label_vertical_space, DpToPx.dpToPx(  8));
