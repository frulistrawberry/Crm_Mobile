...
public class FontEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.FontEditText, defStyleAttr, 0);
        int fontStyleValue = typedArray.getInt(R.styleable.FontEditText_font_textStyle, FontStyle.LIGHT.valueOf());
