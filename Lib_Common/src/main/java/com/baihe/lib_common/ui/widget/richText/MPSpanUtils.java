 ...
 * </pre>
 */
public final class MPSpanUtils {
     ...
     *             </ul>
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setStrikethrough() {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setUnderline() {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setSuperscript() {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setSubscript() {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final Blur style) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final float dx,
                                 final float dy,
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link MPSpanUtils} instance
     */
    public MPSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
