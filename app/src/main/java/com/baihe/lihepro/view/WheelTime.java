...
public class WheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        wv_schedule = (WheelView) view.findViewById(R.id.wv_schedule);
         items = new ArrayList<>();
        items.add("午宴");
        items.add("晚宴");
        wv_schedule.setAdapter(new ArrayWheelAdapter(items));
        //wv_seconds.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字
        wv_schedule.setCurrentItem(0);
        wv_schedule.setGravity(gravity);
        ...
        setChangedListener(wv_schedule);
        wv_schedule.setOnItemSelectedListener(new OnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
                mSelectChangeCallback.onTimeSelectChanged();
            }
...
//                maxItem = endD;
    ...
    private void setContentTextSize() {
        ...
        wv_schedule.setTextSize(textSize);
    }
    ...
    private void setTextColorOut() {
        ...
        wv_schedule.setTextColorOut(textColorOut);
    }
    ...
    private void setTextColorCenter() {
        ...
        wv_schedule.setTextColorCenter(textColorCenter);
    }
    ...
    private void setDividerColor() {
        ...
        wv_schedule.setDividerColor(dividerColor);
    }
    ...
    private void setDividerType() {
        ...
        wv_schedule.setDividerType(dividerType);
    ...
    private void setLineSpacingMultiplier() {
        ...
        wv_schedule.setLineSpacingMultiplier(lineSpacingMultiplier);
    }
    ...
    public String getSchedule(){
        return items.get(wv_schedule.getCurrentItem());
    }
