...
import com.baihe.lihepro.adapter.CustomerServiceListPagerAdapter;
...
public class CustomerServiceListActivity extends BaseActivity {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, CustomerServiceListActivity.class);
    ...
    private CustomerServiceListPagerAdapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitleView(R.layout.activity_service_list_title);
    ...
    private void init2Tab() {
        btnTab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isTeam = false;
                tab1.setFontStyle(FontTextView.FontStyle.BOLD);
        ...
        btnTab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isTeam = true;
                tab2.setFontStyle(FontTextView.FontStyle.BOLD);
    ...
    private void loadData() {
        HttpTask taskFilter = HttpTask.create(HttpRequest.create(UrlConstant.FILTER_CONFIGT_URL).putParam(new JsonParam("params")
                .putParamValue("tab", "CustomerService")));
        HttpTask taskTabs = HttpTask.create(HttpRequest.create(UrlConstant.CUSTOMER_SERVICE_PHASE_URL));
        HttpRequestManager.newInstance().get(taskFilter, new HttpRequestManager.TaskCallBack<ArrayList<FilterEntity>>() {
            ...
            public void success(ArrayList<FilterEntity> filterEntities) {
                CustomerServiceListActivity.this.filterEntities = filterEntities;
            }
            ...
            public void success(RequirementTabEntity tabEntity) {
                CustomerServiceListActivity.this.tabEntity = tabEntity;
            }
    ...
    private void initTab() {
        ...
        adapter = new CustomerServiceListPagerAdapter(getSupportFragmentManager(), tabEntity);
    ...
    private void listener() {
        ...
        requirement_list_title_search_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RequirementSearchActivity.start(context,1);
            }
        });
    }
    ...
    public void refresh() {
        ...
        for (int i = 0; i < count; i++) {
            CustomerServiceListFragment requirementListFragment = getFragment(i);
    ...
    private CustomerServiceListFragment getFragment(int index) {
        ...
        if (fragment != null && fragment instanceof CustomerServiceListFragment) {
            return (CustomerServiceListFragment) fragment;
        }
        return null;
    }
}
