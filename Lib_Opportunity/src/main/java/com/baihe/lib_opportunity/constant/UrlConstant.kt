package com.baihe.lib_opportunity.constant
...
object UrlConstant {
    ...
    const val TRANSFER_OPPORTUNITY = "/owner/customer/transferOppo"
    const val DISPATCH_ORDER = "/owner/customer/planceOrder"
    const val FOLLOW_LOG = "/owner/customer/followLog"
    const val OPPO_TEMPLE = "/owner/requirement/oppoTemple"
}