package com.baihe.lib_home.ui.widget.chart;
...
public class PieChartRenderer extends DataRenderer {
    ...
    public PieChartRenderer(PieChart chart, ChartAnimator animator,
        ...
        mEntryLabelsPaint.setTextSize(Utils.convertDpToPixel(14f));
    ...
    protected void drawDataSet(Canvas c, IPieDataSet dataSet) {
        ...
        for (int j = 0; j < entryCount; j++) {
            ...
            colors[0] = dataSet.getGradientColor(j).getStartColor();
            colors[1] = dataSet.getGradientColor(j).getEndColor();
            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                if (drawXOutside || drawYOutside) {
                    ...
                    if (transformedAngle % 360.0 >= 90.0 && transformedAngle % 360.0 <= 270.0) {
                        pt2x = pt1x - mEntryLabelsPaint.measureText(entryLabel)-DpToPx.dpToPx(2);
                        pt2y = pt1y;
                        circleX = pt2x-DpToPx.dpToPx(2);
                        circleY = pt2y;
                    ...
                    if (dataSet.getValueLineColor() != ColorTemplate.COLOR_NONE) {
                        ...
                        circlePaint.setShader(new SweepGradient(circleX,circleY,dataSet.getGradientColor(j).getStartColor(),dataSet.getGradientColor(j).getEndColor()));
                        c.drawLine(pt0x, pt0y, pt1x, pt1y, mValueLinePaint);
                        c.drawLine(pt1x, pt1y, pt2x, pt2y, mValueLinePaint);
                        c.drawCircle(circleX,circleY,DpToPx.dpToPx(4),circlePaint);
                    ...
                    if (drawXOutside && drawYOutside) {
                        ...
                        drawValue(c, formattedValue, labelPtx, labelPty + lineHeight, dataSet.getValueTextColor(j));

                        if (j < data.getEntryCount() && entryLabel != null) {
                            drawEntryLabel(c, entryLabel, labelPtx, labelPty-DpToPx.dpToPx(8) );
                        }
